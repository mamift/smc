                                                        ...
                                                        bool        baseOnly)
{
    ...
    //  This call may cause ambiguity errors to be issued, which is inappropriate here, right?
    ...
    if  (ourComp->cmpCurScp)
    {
             ...
             lclScp = lclScp->sdParent)
        {
            ...
            if  (lclScp->sdIsImplicit && lclScp->sdSymKind == SYM_SCOPE)
            {
                ...
                if  (sym)
                {
                    //  Check for ambiguity --> ERRimplAmbig
...
SymTab              SymDefRec::sdOwnerST()
{
    ...
    //  How the heck do we figure out which symbol table this symbol
    //  belongs to? For now, just use the global one ....
