...
//              static int x; if (++x == 0) forceDebugBreak();
            ...
            GET_DCL:
                ...
                for (;;)
                {
                    ...
                    //  Make sure the declaration doesn't span a conditional compilation boundary!
...
//  static int x; if (++x == 0) forceDebugBreak();
    ...
    ERR:
        ...
        for (;;)
        {
            //  The following doesn't always work, need to pay attention to 'chkOnly'
    ...
    default:
        ...
        QUALCHK:
            ...
            for (;;)
            {
                ...
                case tkMul:
                case tkLBrack:
                    //  add more things that start a type
                    return  true;
...
Tree                parser::parseSetExpr(treeOps oper)
{
    ...
    if  (oper == TN_PROJECT)
    {
        ...
        default:
            ...
            /*  Make sure the type is an acceptable one */
