        ...
        *numPtr++ = ch;
        ...
        case 'L':
            ...
            if  (scanTok.tok == tkIntCon)
            {
                ...
                goto ENDN;  //  check for "LU" suffix on numbers
            }
            break;
...
ENDN:
    ...
    {
        //  check for illegal float number!
    ...
    else
    {
        ...
        if  (*def)
        {
            ...
            else
            {
                ...
                //  Need to detect indirect recursion as well!!!!!!!
            }
        }
