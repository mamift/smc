...
STORE:
    ...
    if  (valUsed)
    {
        if  (ncns)
        {
            ...
            //  for signed bitfields we have to bash the upper bits!
...
void                genIL::genSortCmp(Tree val1, Tree val2, bool last)
{
    ...
    genOpcode(CEE_DUP);
    labTmp = genFwdLabGet();
assert(val1->tnVtyp == TYP_INT || val1->tnVtyp == TYP_UINT); genIntConst(0);    //  we need to use a 0 with the proper type!!!!!!
...
//              case TN_FNC_SYM:
            ...
            if  (valUsed)
            {
                ...
                //  Only do this if const fits in target!
                ...
                else
                {
                    ...
                    //  target may have smaller size, result must match!!!!
        ...
        CHK_CAST:
                 ...
                 varTypeIsIntegral(srcType))
            {
                ...
                /*  cover more cases of worthless casts */
