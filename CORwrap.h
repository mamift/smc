...
struct  WMetaDataImport : WMetaData
{
    ...
    COR_IMPORT("CORwrap.dll", "?GetPropertyProps@WMetaDataImport@@QAGHIPAIPBGKPAK2PAPB_E22PAPBX200QAIK2@Z")
...
struct  WMetaDataEmit : WMetaData
{
    ...
    COR_IMPORT("CORwrap.dll", "?DefineProperty@WMetaDataEmit@@QAGHIPBGKPB_EKKPBXKIIQAIPAI@Z")
...
COR_IMPORT("CORwrap.dll", "?WRAPPED_CorSigUncompressSignedInt@@YGKPB_EPAH@Z")
